...
public class SWSystemData {
    ...
    private static SWSystem createECommercePlatform(){
        ...
        funcSuit.addCriterion(new Criterion("Functional Completeness Ratio",50,"higher", 0,120,"%"));
        funcSuit.addCriterion(new Criterion("Functional Correctness Ratio",50,"higher", 0,120,"%"));
        ...
        maintainability.addCriterion(new Criterion("Test Coverage Ratio", 50,"higher",40,100,"%"));
        maintainability.addCriterion(new Criterion("Cyclomatic Complexity", 50,"lower",0,20,"score"));
        s.addDimension(maintainability);

        return s;
    }
    private static SWSystem createBankingPortal() {
        return new SWSystem("SecureBank","Web","2.0");
    }

    private static SWSystem createHealthApp() {
        return new SWSystem("HealthTrack","Mobile","1.5");
    }
}
